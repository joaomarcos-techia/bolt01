/*
  ...
  2. Security
    ...
    - Add constraint to restrict admin email
    - Create auto-promotion trigger for admin user
  ...
  4. Functions
    ...
    - Create auto-promotion trigger function
*/
...
-- Create admin dashboard stats view (without security_definer parameter)
